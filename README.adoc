...
// URIs:
:uri-qg-status: https://sonarcloud.io/dashboard?id=sonarsource-cfamily-examples_macos-cmake-otherci-sc
:img-qg-status: https://sonarcloud.io/api/project_badges/measure?project=sonarsource-cfamily-examples_macos-cmake-otherci-sc&metric=alert_status
:uri-build-status: https://github.com/sonarsource-cfamily-examples/macos-cmake-otherci-sc/actions/workflows/build.yml
:img-build-status: https://github.com/sonarsource-cfamily-examples/macos-cmake-otherci-sc/actions/workflows/build.yml/badge.svg

image:{img-build-status}[Build Status, link={uri-build-status}]
image:{img-qg-status}[Quality Gate Status,link={uri-qg-status}]

*This project is analysed on https://sonarcloud.io/dashboard?id=sonarsource-cfamily-examples_macos-cmake-otherci-sc[SonarCloud]!*
...
The `build-analyze.sh` script demonstrates how to run an analysis on a C++ project build. Note that for security reasons, the environment variable `SONAR_TOKEN` is defined in the environement through github secrets. It should not be made public. Github actions are used for demonstration purpose as any CI could be used to run the `build-analyze.sh` script.

You can take a look at the script link:buid-analyze.sh[buid-analyze.sh] of this project to see it in practice.
