...
Note that for security reasons, the token `SONAR_TOKEN` used  in this example project is defined in the environment through GitHub secrets. It should not be made public.
